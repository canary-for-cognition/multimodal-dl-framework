...
def main():
    ...
    base_path_to_modalities = os.path.join("", "../../../../utils", "..", "dataset", "alzheimer", "modalities")
    modalities = ["audio/networks", "text", "sequences/eye_tracking/raw",
                  "eye_tracking/eye_tracking/heatmaps_tobii/networks"]
