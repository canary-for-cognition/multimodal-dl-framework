...
def convert_files(file_base_names: list, dataset: pd.DataFrame) -> list:
    unique_items = []
...
def check_patients_availability(unique_items: list, path_to_sequences: str, labels: dict):
...
def check_sets_difference(unique_items: list, dataset: pd.DataFrame):
