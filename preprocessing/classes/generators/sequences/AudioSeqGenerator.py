...
class AudioSeqGenerator(Generator):

    def __init__(self):
        super().__init__("audio_sequences")
        self.__sample_rate = self._params["sample_rate"]
        self.__paths_to_raw_sequences = self._paths.create_paths(self._params["path_to_src"])
        self.__paths_to_base_sequences = self._paths.create_paths(self._params["path_to_dest"])
